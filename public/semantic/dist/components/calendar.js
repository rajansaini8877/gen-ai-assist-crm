  ...
  $.fn.calendar = function (parameters) {
    ...
    $allModules.each(function () {
      var settings = $.isPlainObject(parameters)
        ...
        $container =
          instance && instance.popupId
            ? $document.find("#" + instance.popupId)
            : $module.find(selector.popup),
        isTouch,
        isTouchDown = false,
      ...
      module = {
            ...
            if ($container.length === 0) {
              if (settings.context) {
                module.popupId =
                  namespace +
                  "_popup_" +
                  (Math.random().toString(16) + "000000000").slice(2, 10);
                $container = $("<div/>", { id: module.popupId })
                  .addClass(className.popup)
                  .appendTo($document.find(settings.context));
              } else {
          ...
          calendar: function () {
            ...
            var mode = module.get.mode(),
              ...
              display = module.helper.dateInRange(
                focusDate ||
                  date ||
                  parser.date(settings.initialDate, settings) ||
                  today,
              );
            if (!focusDate) {
              focusDate = display;
            ...
            for (p = 0; p < pages; p++) {
              ...
              if (!isTimeOnly) {
                ...
                var headerText = $("<span/>")
                  ...
                  .appendTo(cell);
                headerText.text(
                  module.helper.dateFormat(
                    formatter[mode + "Header"],
                    headerDate,
                  ),
                );
                var newMode = isMonth
                  ...
                  : isDay
                    ? settings.disableMonth
                      ? "year"
                      : "month" // eslint-disable-line unicorn/no-nested-ternary
                    : "day";
              ...
              for (r = 0; r < rows; r++) {
                ...
                for (c = 0; c < textColumns; c++, i++) {
                  ...
                  if (disabled) {
                    ...
                    if (mode === "hour") {
                      var disabledHour = module.helper.findHourAsObject(
                        cellDate,
                        mode,
                      ...
                      if (
                        ...
                        cell.attr(
                          "data-position",
                          disabledHour[metadata.position] || tooltipPosition,
                        );
                        if (
                          disabledHour[metadata.inverted] ||
                          (isInverted &&
                            disabledHour[metadata.inverted] === undefined)
                        ) {
                          cell.attr("data-inverted", "");
                        }
                        if (disabledHour[metadata.variation]) {
                          cell.attr(
                            "data-variation",
                            disabledHour[metadata.variation],
                          );
                        }
                      }
                    }
        ...
        event: {
            ...
            if (module.popup("is visible")) {
              ...
              switch (keyCode) {
                ...
                case 40: {
                  var bigIncrement =
                    mode === "day"
                      ...
                      : mode === "hour"
                        ...
                        : mode === "minute"
                          ? timeGap.column
                          : 3; // eslint-disable-line unicorn/no-nested-ternary
                  var increment =
                    keyCode === 37
                      ? -1
                      : keyCode === 38
                        ...
                        : keyCode === 39
                          ? 1
                          : bigIncrement; // eslint-disable-line unicorn/no-nested-ternary
                  ...
                  var minute =
                    focusDate.getMinutes() +
                    (mode === "minute" ? increment : 0);
          ...
          inputBlur: function () {
            ...
            if (settings.formatInput) {
              var date = module.get.date();
              var text = module.helper.dateFormat(
                formatter[settings.type],
                date,
              );
              $input.val(text);
            }
        ...
        get: {
          ...
          formattedDate: function (format, date) {
            return module.helper.dateFormat(
              format || formatter[settings.type],
              date || module.get.date(),
            );
          },
          date: function () {
          ...
          monthOffset: function () {
            return (
              $module.data(metadata.monthOffset) || settings.monthOffset || 0
            );
          },
          mode: function () {
          ...
          validatedMode: function (mode) {
            ...
            return settings.type === "time"
              ...
              : settings.type === "month"
                ...
                : settings.type === "year"
                  ? "year"
                  : "day"; // eslint-disable-line unicorn/no-nested-ternary
          },
          type: function () {
            ...
            var newMode =
              mode === "year"
                ...
                : mode === "month"
                  ...
                  : mode === "day"
                    ? "hour"
                    : "minute"; // eslint-disable-line unicorn/no-nested-ternary
        ...
        helper: {
          dateFormat: function (format, date) {
            ...
            var D = date.getDate(),
              ...
              a =
                H < 12
                  ? settings.text.am.toLowerCase()
                  : settings.text.pm.toLowerCase(),
              tokens = {
                D: D,
                DD: ("0" + D).slice(-2),
                M: M + 1,
          ...
          isDisabled: function (date, mode) {
            return (
              ...
              ((mode === "day" &&
                  ...
                  if (d instanceof Date) {
                    ...
                    if (d[metadata.year]) {
                      ...
                      if (typeof d[metadata.month] === "number") {
                        ...
                        blocked =
                          d[metadata.month].indexOf(date.getMonth()) > -1;
                      ...
                      if (d[metadata.date] instanceof Date) {
                        blocked = module.helper.dateEqual(
                          date,
                ...
                (mode === "hour" &&
                  settings.disabledHours.some(function (d) {
                    var blocked = false;
                    ...
                    if (d instanceof Date) {
                      ...
                      if (d[metadata.days]) {
                        if (typeof d[metadata.days] === "number") {
                          ...
                          blocked =
                            d[metadata.days].indexOf(date.getDay()) > -1;
                        }
                      }
                      ...
                      if (d[metadata.hours]) {
                        if (typeof d[metadata.hours] === "number") {
                          blocked =
                            blocked && date.getHours() === d[metadata.hours];
                        } else if (Array.isArray(d[metadata.hours])) {
                          blocked =
                            blocked &&
                            d[metadata.hours].indexOf(date.getHours()) > -1;
                        }
                      }
                    }
              ...
              return (
                ...
                settings.enabledDates.some(function (d) {
                  ...
                  if (d instanceof Date) {
                    ...
                    enabled = module.helper.dateEqual(
                      date,
                      module.helper.sanitiseDate(d[metadata.date]),
                      mode,
                    );
          ...
          findHourAsObject: function (date, mode, hours) {
            if (mode === "hour") {
              ...
              var hourCheck = function (date, d) {
                if (d[metadata.hours]) {
                  if (
                    typeof d[metadata.hours] === "number" &&
                    date.getHours() === d[metadata.hours]
                  ) {
                    return d;
                  }
              ...
              for (var i = 0; i < hours.length; i++) {
                ...
                if (d !== null && typeof d === "object") {
                  if (d[metadata.days] && hourCheck(date, d)) {
                    if (
                      typeof d[metadata.days] === "number" &&
                      date.getDay() === d[metadata.days]
                    ) {
                      return d;
                    }
            ...
            return !date
              ...
              : minDate && module.helper.dateDiff(date, minDate, "minute") > 0
                ? isTimeOnly
                  ...
                  : minDate // eslint-disable-line unicorn/no-nested-ternary
  ...
  $.fn.calendar.settings = {
    ...
    parser: {
      date: function (text, settings) {
        ...
        text =
          settings.monthFirst || !/^\d{1,2}[./-]/.test(text)
            ? text
            : text.replace(/[./-]/g, "/").replace(/(\d+)\/(\d+)/, "$2/$1");
    ...
    regExp: {
      ...
      dateNumbers: /[^\d:]+/g,
      token:
        /d{1,4}|D{1,2}|M{1,4}|YY(?:YY)?|([Hhmsw])\1?|[ASYa]|"[^"]*"|'[^']*'/g,
    },
