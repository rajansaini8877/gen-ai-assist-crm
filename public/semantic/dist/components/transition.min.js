 ...
 */
!(function (h, n) {
  (void 0 !== n && n.Math === Math) || globalThis,
    (h.fn.transition = function () {
      var p,
        o = h(this),
        r = Date.now(),
        s = [],
      ...
      return (
        o.each(function (i) {
          var l,
            ...
            f = {
              initialize: function () {
                (l = f.get.settings.apply(m, g)),
                  (c = l.className),
                  (e = l.error),
                  (t = l.metadata),
                  (a = "." + l.namespace),
                  (n = "module-" + l.namespace),
                  (d = u.data(n) || f),
                  !1 === (y = y && f.invoke(v)) &&
                    (f.verbose("Converted arguments into settings object", l),
                    l.interval ? f.delay(l.interval) : f.animate(),
                    f.instantiate());
              },
              ...
              destroy: function () {
                f.verbose("Destroying previous module for", m), u.removeData(n);
              },
              refresh: function () {
              ...
              delay: function (n) {
                var e =
                  (e = f.get.animationDirection()) ||
                  (f.can.transition() ? f.get.direction() : "static");
                (n = void 0 !== n ? n : l.interval),
                  (e =
                    ("auto" === l.reverse && e === c.outward) ||
                    !0 === l.reverse
                      ? (o.length - i) * n
                      : i * n),
              ...
              animate: function (n) {
                if (
                  ((l = n || l),
                  f.debug("Preparing animation", l.animation),
                  f.is.animating())
                ) {
                  if (l.queue)
                    return (
                  ...
                  if (!l.allowRepeats && f.is.occurring())
                    return (
                      f.debug(
                ...
                f.can.animate()
                  ? f.set.animating(l.animation)
                  : f.error(e.noAnimation, l.animation, m);
              },
              reset: function () {
              ...
              queue: function (n) {
                f.debug("Queueing animation of", n),
                  (f.queuing = !0),
                  u.one("animationend.queue" + a, function () {
                    (f.queuing = !1), f.repaint(), f.animate.apply(this, l);
                  });
              },
              complete: function (n) {
                n && n.target === m && n.stopPropagation(),
                  f.debug("Animation complete", l.animation),
                  ...
                  f.is.looping() ||
                    (f.is.outward()
                      ? (f.verbose("Animation is outward, hiding element"),
                        ...
                        f.hide())
                      : f.is.inward()
                        ? (f.verbose("Animation is inward, showing element"),
                          f.restore.conditions(),
                          f.show())
              ...
              force: {
                visible: function () {
                  var n = u.attr("style"),
                    n = f.get.userStyle(n),
                    e = f.get.displayType(),
                    n = n + "display: " + e + " !important;",
                    i = u[0].style.display;
                  return !e ||
                    ("none" === i && l.skipInlineHidden) ||
                ...
                hidden: function () {
                  var n = u.attr("style"),
                    n = void 0 === n || "" === n;
                  "none" === u.css("display") || f.is.hidden()
                    ? n && u.removeAttr("style")
              ...
              has: {
                direction: function (n) {
                  var i = !1;
                  return (
                    "string" == typeof (n = n || l.animation) &&
                      ((n = n.split(" ")),
                      h.each(n, function (n, e) {
              ...
              set: {
                animating: function (n) {
                  f.remove.completeCallback(), (n = n || l.animation);
                  n = f.get.animationClass(n);
                  f.save.animation(n),
                    f.force.visible() &&
                      (f.remove.hidden(),
                      f.remove.direction(),
                ...
                duration: function (n, e) {
                  (!(e =
                    "number" == typeof (e = e || l.duration) ? e + "ms" : e) &&
                    0 !== e) ||
                    (f.verbose("Setting animation duration", e),
                    u.css({ "animation-duration": e }));
                },
                direction: function (n) {
                ...
                inward: function () {
                  f.debug("Setting direction to inward"),
                    u.removeClass(c.outward).addClass(c.inward);
                },
                outward: function () {
                  f.debug("Setting direction to outward"),
                    u.removeClass(c.inward).addClass(c.outward);
                },
                visible: function () {
              ...
              start: {
                animation: function (n) {
                  (n = n || f.get.animationClass()),
                    ...
                    u.addClass(n).one("animationend.complete" + a, f.complete),
                    l.useFailSafe && f.add.failSafe(),
                    f.set.duration(l.duration),
                    l.onStart.call(m);
                },
              },
              save: {
                ...
                displayType: function (n) {
                  "none" !== n && u.data(t.displayType, n);
                },
                transitionExists: function (n, e) {
                  (h.fn.transition.exists[n] = e),
              ...
              remove: {
                ...
                looping: function () {
                  f.debug("Transitions are no longer looping"),
                    f.is.looping() && (f.reset(), u.removeClass(c.looping));
                },
                transition: function () {
                  u.removeClass(c.transition)
              ...
              get: {
                settings: function (n, e, i) {
                  return "object" == typeof n
                    ? h.extend(!0, {}, h.fn.transition.settings, n)
                    : "function" == typeof i
                      ? h.extend({}, h.fn.transition.settings, {
                          animation: n,
                          onComplete: i,
                          duration: e,
                        })
                      : "string" == typeof e || "number" == typeof e
                        ...
                        : "object" == typeof e
                          ? h.extend({}, h.fn.transition.settings, e, {
                              animation: n,
                            })
                          : "function" == typeof e
                            ? h.extend({}, h.fn.transition.settings, {
                  ...
                  var n = n || l.animation,
                    e =
                      f.can.transition() && !f.has.direction()
                        ? f.get.direction() + " "
                        : "";
                  return c.animating + " " + c.transition + " " + e + n;
                },
                currentAnimation: function () {
                  return (
                    !(!f.cache || void 0 === f.cache.animation) &&
                    f.cache.animation
                  );
                },
                ...
                displayType: function (n) {
                  return (
                    l.displayType ||
                    ((n = void 0 === n || n) &&
                      void 0 === u.data(t.displayType) &&
                      ("" === (n = u.css("display")) || "none" === n
                        ? f.can.transition(!0)
                        : f.save.displayType(n)),
                    u.data(t.displayType))
                  );
                },
                userStyle: function (n) {
                  return (n = n || u.attr("style") || "").replace(
                    /display.*?;/,
                    "",
                  );
                },
                transitionExists: function (n) {
                  return h.fn.transition.exists[n];
                },
              },
              can: {
                  ...
                  if (void 0 === r || n) {
                    if (
                      ...
                      (i = (e = h("<" + e + " />")
                        ...
                        .css("animationName")),
                      e.detach().insertAfter(u),
                      (t = e.addClass(c.inward).css("animationName")),
                      s ||
                        (e.detach().insertAfter(u),
                        (s = e
                          .attr("class", n)
                          ...
                          .show()
                          .css("display")),
                        f.verbose("Determining final display state", s),
                        f.save.displayType(s)),
                      e.remove(),
                      i !== t)
                    )
                      f.debug("Direction exists for animation", o), (a = !0);
                    else {
                      if ("none" === i || !i)
                        return void f.debug("No animation defined in css", o);
                ...
                animate: function () {
                  return void 0 !== f.can.transition();
                },
              },
              is: {
                animating: function () {
              ...
              hide: function () {
                ...
                f.verbose("Hiding element"),
                  ...
                  f.remove.display(),
                  f.remove.visible(),
                  l.onBeforeHide.call(m, f.hideNow);
              },
              hideNow: function () {
                f.set.hidden(),
                  f.force.hidden(),
              ...
              show: function (n) {
                f.force.visible() &&
                  ...
                  f.remove.hidden(),
                  l.onBeforeShow.call(m, f.showNow));
              },
              showNow: function () {
                f.set.visible(), l.onVisible.call(m), l.onComplete.call(m);
              },
              toggle: function () {
              ...
              setting: function (n, e) {
                if ((f.debug("Changing setting", n, e), h.isPlainObject(n)))
                  h.extend(!0, l, n);
                else {
                  if (void 0 === e) return l[n];
                  h.isPlainObject(l[n]) ? h.extend(!0, l[n], e) : (l[n] = e);
                }
              },
              internal: function (n, e) {
                if (h.isPlainObject(n)) h.extend(!0, f, n);
                else {
                  if (void 0 === e) return f[n];
                  f[n] = e;
                }
              },
              debug: function () {
              ...
              performance: {
                ...
                display: function () {
                  ...
                  (r = !1),
                    clearTimeout(f.performance.timer),
                    h.each(s, function (n, e) {
                      i += e["Execution Time"];
                    }),
                    (n += " " + i + "ms"),
                    1 < o.length && (n += " (" + o.length + ")"),
                    0 < s.length &&
                      ...
                      var i =
                        n !== a
                          ? e +
                            ...
                            t[n + 1].slice(1)
                          : t;
                      if (h.isPlainObject(s[i]) && n !== a) s = s[i];
                      else {
                        if (void 0 !== s[i]) return (o = s[i]), !1;
                        {
                          if (!h.isPlainObject(s[e]) || n === a)
                            return void 0 !== s[e] && (o = s[e]), !1;
                          s = s[e];
                        }
                      }
                    })),
                  "function" == typeof (r = o) && "number" != typeof r.nodeType
                    ? (i = o.apply(e, n))
                    : void 0 !== o && (i = o),
                  Array.isArray(p)
                    ? p.push(i)
    ...
    (h.fn.transition.exists = {}),
    (h.fn.transition.settings = {
      name: "Transition",
      silent: !1,
      debug: !1,
      verbose: !1,
