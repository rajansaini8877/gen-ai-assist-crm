          ...
          if (
            ...
            activeTab =
              settings.autoTabActivation === true
                ...
                : settings.autoTabActivation;
            module.debug(
              "No active tab detected, setting tab active",
              activeTab,
            );
        ...
        changeTab: function (tabPath) {
          ...
          $.each(pathArray, function (index, tab) {
            ...
            if (isTab) {
              ...
              if (
                settings.onBeforeChange.call(element, currentPath) === false
              ) {
                module.debug(
                  "onBeforeChange returned false, cancelling tab change",
                  $tab,
                );
