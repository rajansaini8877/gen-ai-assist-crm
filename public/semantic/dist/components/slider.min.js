        ...
        e.each(function () {
          var l,
            ...
            E = {
              ...
              setup: {
                layout: function () {
                  void 0 === R.attr("tabindex") && R.attr("tabindex", 0),
                    ...
                    p.showThumbTooltip &&
                      s
                        .attr("data-position", p.tooltipConfig.position)
                        .attr("data-variation", p.tooltipConfig.variation),
                    (l = s),
                    E.is.range() &&
                ...
                labels: function () {
                  E.is.labeled() &&
                    (0 < (c = R.find(".labels:not(.auto)")).length
                      ? E.setup.customLabel()
                      : E.setup.autoLabel(),
                    p.showLabelTicks) &&
                    R.addClass(n.ticked);
                ...
                autoLabel: function () {
                  0 < (c = R.find(".labels")).length
                    ? c.empty()
                    : (c = R.append('<ul class="auto labels"></ul>').find(
                        ".labels",
                      ));
                  for (var e = 0, t = E.get.numLabels(); e <= t; e++) {
                    var n = E.get.label(e),
                      a =
                        0 === p.restrictedLabels.length ||
                        0 <= p.restrictedLabels.indexOf(n),
                      a =
                        "" === n || (!a && "always" !== p.showLabelTicks)
                          ? null
                          : e % E.get.gapRatio()
                            ? X('<li class="halftick label"></li>')
                            : X('<li class="label">' + (a ? n : "") + "</li>");
                    a && (E.update.labelPosition(e / t, a), c.append(a));
                  }
                },
              },
              bind: {
                ...
                mouseEvents: function () {
                  E.verbose("Binding mouse and touch events"),
                    ...
                    R.on("mouseenter" + x, function (e) {
                      y = !0;
                    }),
                    R.on("mouseleave" + x, function (e) {
                      y = !1;
                    }),
                    R.find(".thumb")
                      ...
                      .on("touchcancel" + x, E.event.touchCancel);
                },
              ...
              unbind: {
                events: function () {
                  R.find(".track, .thumb, .inner").off("mousedown" + x),
                    R.off("mousedown" + x),
                    R.off("mouseenter" + x),
                    R.off("mouseleave" + x),
                    R.find(".thumb")
                    ...
                    R.off("keydown" + x),
                    R.off("focusout" + x),
                    A.off("keydown" + x + t, E.event.activateFocus),
                    F.off("resize" + x);
                },
                slidingEvents: function () {
              ...
              event: {
                      ...
                      ? ((e = E.determine.eventPos(e)),
                        ...
                        (l =
                          ...
                          E.thumbVal === E.secondThumbVal
                            ? void (i = e)
                            : E.determine.closestThumb(e)),
                        void 0 === b && (b = E.get.currentThumbValue()))
                ...
                move: function (e) {
                  if (
                    ...
                    var t = E.determine.valueFromEvent(e);
                    if (
                      ("mousemove" === e.type &&
                        void 0 === l &&
                        ...
                        (n = E.determine.pos(n)),
                        (l = n < i ? s : u)),
                      E.is.range() && (p.minRange || p.maxRange))
                    ) {
                      ...
                      if (
                        ...
                        (p.preventCrossover && !a && t > E.secondThumbVal) ||
                        (p.preventCrossover && a && t < E.thumbVal)
                      )
                        return;
                    }
                    0 === E.get.step() || E.is.smooth()
                      ? ((n = E.thumbVal),
                        (a = E.secondThumbVal),
                        (e = E.determine.smoothValueFromEvent(e)),
                        l.hasClass("second")
                          ? (p.preventCrossover &&
                              E.is.range() &&
                          ...
                          : (p.preventCrossover &&
                              E.is.range() &&
                              ((t = Math.min(a, t)), (e = Math.min(a, e))),
                            (n = t)),
                        (t = Math.abs(n - (a || 0))),
                        E.update.position(e),
                        p.onMove.call(C, t, n, a))
                      : E.update.value(t, function (e, t, n) {
                  ...
                  e.preventDefault(),
                    E.is.disabled() ||
                      ...
                      E.is.range() &&
                        ...
                        (void 0 === l &&
                          (l = e <= E.get.currentThumbValue() ? s : u),
                        (t = E.get.currentRangeDiff(e)),
                        p.minRange && t < p.minRange
                          ? (e = E.get.edgeValue(e, p.minRange))
                          : p.maxRange &&
                            t > p.maxRange &&
                            (e = E.get.edgeValue(e, p.maxRange))),
                      E.set.value(e),
                      E.unbind.slidingEvents(),
                      (r = void 0) !== b && (b = void 0));
                },
                touchCancel: function (e) {
                  e.preventDefault(),
                    (r = void 0) !== b && (E.update.value(b), (b = void 0));
                },
              ...
              resync: function () {
                E.verbose("Resyncing thumb position based on value"),
                  E.is.range() && E.update.position(E.secondThumbVal, u),
              ...
              takeStep: function (e) {
                e = e || 1;
                var t = E.get.step(),
                  n = E.get.currentThumbValue();
                E.verbose("Taking a step"),
                  0 < t
                    ? E.set.value(n + t * e)
                    : 0 === t &&
                      ((t = E.get.precision()),
                      E.set.value(Math.round((n + e / t) * t) / t));
              },
              backStep: function (e) {
                e = e || 1;
                var t = E.get.step(),
              ...
              get: {
                ...
                trackOffset: function () {
                  return E.is.vertical() ? e.offset().top : e.offset().left;
                },
                trackLength: function () {
                  return E.is.vertical() ? e.height() : e.width();
                },
                trackLeft: function () {
                  return E.is.vertical() ? e.position().top : e.position().left;
                },
                ...
                max: function () {
                  var e = E.get.step(),
                    ...
                    n =
                      0 === e
                        ? 0
                        : Math.floor(Math.round(((p.max - t) / e) * n) / n);
                ...
                numLabels: function () {
                  var e = E.get.step(),
                    ...
                    e =
                      Math.round(
                        ((E.get.max() - E.get.min()) / (0 === e ? 1 : e)) * t,
                      ) / t;
                  return (
                    E.debug("Determined that there should be " + e + " labels"),
                    e
                  );
                },
                labelType: function () {
                ...
                label: function (e) {
                  ...
                  switch (p.labelType) {
                    case p.labelTypes.number:
                      var t = E.get.step();
                      return (
                        Math.round((e * (0 === t ? 1 : t) + E.get.min()) * o) /
                        o
                      );
              ...
              determine: {
                pos: function (e) {
                  return E.is.reversed()
                    ? E.get.trackStartPos() - e + E.get.trackOffset()
                    : e - E.get.trackOffset() - E.get.trackStartPos();
                },
                closestThumb: function (e) {
                  var t = parseFloat(E.determine.thumbPos(s)),
                    t = Math.abs(e - t),
                    n = parseFloat(E.determine.thumbPos(u)),
                    e = Math.abs(e - n);
                  return (t !== e || E.get.thumbValue() !== E.get.min()) &&
                    t <= e
                    ? s
                    : u;
                },
                closestThumbPos: function (e) {
                  var t = parseFloat(E.determine.thumbPos(s)),
                    n = Math.abs(e - t),
                    a = parseFloat(E.determine.thumbPos(u));
                    ...
                    e =
                      e < E.get.trackOffset()
                        ? E.is.reversed()
                          ? E.get.max()
                          : E.get.min()
                        : e > E.get.trackOffset() + E.get.trackLength()
                          ? E.is.reversed()
                            ? E.get.min()
                            : E.get.max()
                          : E.determine.value(t);
                ...
                smoothValueFromEvent: function (e) {
                  var t = E.get.min(),
                    n = E.get.max(),
                    a = E.get.trackLength(),
                    e = E.determine.eventPos(e) - E.get.trackOffset(),
                    e = (e < 0 ? 0 : a < e ? a : e) / a;
                  return (e = E.is.reversed() ? 1 - e : e) * (n - t) + t;
                },
                eventPos: function (e) {
                  ...
                  var t = E.is.reversed()
                    ...
                    t =
                      ...
                      ((E.is.reversed()
                        ...
                        : E.get.trackEndPos()) -
                        t),
                    n = E.get.max() - E.get.min(),
                    a = E.get.step(),
                    t = t * n,
                    n = 0 === a ? t : Math.round(t / a) * a;
                  return (
                    E.verbose(
                    ...
                    t != n && E.verbose("Rounding value to closest step: " + n),
                    E.verbose("Cutting off additional decimal places"),
              ...
              set: {
                value: function (a, o) {
                  ...
                  (b = void 0 === b ? E.get.value() : b),
                    E.update.value(a, function (e, t, n) {
                      (h && !p.fireOnInit) ||
                        !o ||
                        (a !== b && p.onChange.call(C, e, t, n),
                        p.onMove.call(C, e, t, n)),
                        i && (b = void 0);
                    });
                },
                rangeValue: function (e, t, n) {
                  ...
                  (n = !1 !== n),
                    E.is.range()
                      ? ((a = E.get.min()),
                        (o = E.get.max()),
                        (b = (i = void 0 === b) ? E.get.value() : b),
                        e <= a ? (e = a) : o <= e && (e = o),
                        t <= a ? (t = a) : o <= t && (t = o),
                        (E.thumbVal = e),
                        (E.secondThumbVal = t),
                        (m = Math.abs(E.thumbVal - E.secondThumbVal)),
                        E.update.position(E.thumbVal, s),
                        E.update.position(E.secondThumbVal, u),
                        (h && !p.fireOnInit) ||
                          !n ||
                          (m !== b &&
                            p.onChange.call(C, m, E.thumbVal, E.secondThumbVal),
                          p.onMove.call(C, m, E.thumbVal, E.secondThumbVal)),
                        i && (b = void 0))
                      : E.error(k.notrange);
                },
                position: function (e, t) {
                  ...
                  "second" === t
                    ? ((E.secondThumbVal = e), E.update.position(e, u))
                    : ((E.thumbVal = e), E.update.position(e, s)),
                    (m = Math.abs(E.thumbVal - (E.secondThumbVal || 0))),
                    E.set.value(m);
                },
              },
              update: {
                value: function (e, t) {
                  ...
                  e <= n ? (e = n) : a <= e && (e = a),
                    E.is.range()
                      ? ((l =
                          void 0 === l
                            ? e <= E.get.currentThumbValue()
                              ? s
                              : u
                            : l).hasClass("second")
                          ? (p.preventCrossover &&
                              E.is.range() &&
                              (e = Math.max(E.thumbVal + (p.minRange || 0), e)),
                            (E.secondThumbVal = e))
                          : (p.preventCrossover &&
                              E.is.range() &&
                              (e = Math.min(
                                E.secondThumbVal - (p.minRange || 0),
                                e,
                              )),
                            (E.thumbVal = e)),
                        (m = Math.abs(E.thumbVal - E.secondThumbVal)))
                ...
                position: function (e, t) {
                  var n = E.handleNewValuePosition(e),
                    t = t || l,
                    a = E.thumbVal || E.get.min(),
                    o = E.secondThumbVal || E.get.min();
                  p.showThumbTooltip &&
                    ((r = E.get.precision()),
                  ...
                  var i,
                    ...
                    s = E.get.max(),
                    e = ((e - r) / (s - r)) * 100,
                    u = ((Math.min(a, o) - r) / (s - r)) * 100,
                    a = 100 * (1 - (Math.max(a, o) - r) / (s - r)),
                    o = E.is.vertical()
                      ? E.is.reversed()
                        ? ((i = {
                            bottom: "calc(" + e + "% - " + f + "px)",
                ...
                labelPosition: function (e, t) {
                  var n = E.get.trackStartMargin(),
                    a = E.get.trackEndMargin(),
                    o = E.is.vertical()
                      ? E.is.reversed()
                        ? "bottom"
                        : "top"
              ...
              read: {
                  ...
                  e.thumbVal &&
                    (E.is.range() && e.secondThumbVal
                      ? (E.debug(
                        ...
                        E.set.rangeValue(e.thumbVal, e.secondThumbVal))
                      : (E.debug("Current value set from metadata", e.thumbVal),
                ...
                settings: function () {
                  ...
                  !1 !== p.start &&
                    (E.is.range()
                      ? (((e = p.end - p.start) < 0 ||
                          (p.minRange && e < p.minRange) ||
                          (p.maxRange && e > p.maxRange) ||
                          (p.minRange &&
                            p.maxRange &&
                            p.minRange > p.maxRange)) &&
                          E.error(
                      ...
                      : (E.debug("Start position set from settings", p.start),
                        E.set.value(p.start)));
                },
              },
              setting: function (e, t) {
                if ((E.debug("Changing setting", e, t), X.isPlainObject(e)))
                  X.extend(!0, p, e);
                else {
              ...
              performance: {
                log: function (e) {
                  ...
                  p.performance &&
                    ...
                    (E.performance.timer = setTimeout(function () {
              ...
              invoke: function (a, e, t) {
                ...
                return (
                  ...
                  "string" == typeof a &&
                    ...
                    X.each(a, function (e, t) {
                      var n =
                        e !== o
                          ? t +
                            a[e + 1].charAt(0).toUpperCase() +
                            a[e + 1].slice(1)
                          : a;
                      if (X.isPlainObject(s[n]) && e !== o) s = s[n];
                      else {
                        if (void 0 !== s[n]) return (i = s[n]), !1;
                        {
                          if (!X.isPlainObject(s[t]) || e === o)
                            return (
                              void 0 !== s[t]
                                ? (i = s[t])
                                : E.error(k.method, a),
                  ...
                  "function" == typeof (r = i) && "number" != typeof r.nodeType
                    ? (n = i.apply(t, e))
                    : void 0 !== i && (n = i),
                  Array.isArray(S)
                    ? S.push(n)
